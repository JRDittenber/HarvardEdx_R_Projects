...
# Capstone                                             #
########################################################
#Note--This script will take about 15 minutes to run        #
########################################################
# Import Libraries                                     #
########################################################
...
cat("The final holdout set RMSE results are:\n")
cat(paste("Method", "RMSE", collapse = "\t"))
cat("\n")
lapply(rmse_results, function(x) cat(paste(x, collapse = "\t")))
